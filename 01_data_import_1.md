...
pups_df = read_csv(file = “./data/FAS_pups.csv”, skip = 3)

pups_df = read_csv( file = “data/FAS_litters.csv”, skip = 3)
...
litters_df = read_csv(file = “./data/FAS_litters.csv”, skip = 10,
col_names = FALSE)

head(litters_df)

litters_df = read_csv( file = “./data/FAS_litters.csv”, na = c(“.”,
“NA”, ““))
...
pups_df = read_csv( file = “./data/FAS_pups.csv”, skip = 3, na = c(“.”,
“NA”), col_types = “fddddd”)
